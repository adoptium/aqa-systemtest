 ...
 * using MethodHandles.asType(). All methods are static. 
 *
 */
public class StaticAsTypeTestImplicit {
	

	static boolean explicit = false;
	...
	public static boolean testAll() throws Throwable {
		...
		try {
			...
			testDouble();
			testReference();
		} catch (ImplicitTestFailedException e) {
			passed = false;
		}
	...
	public static void exceptionDuringCast(MethodHandle mh, MethodType mt, Throwable t) {
		...
		t.printStackTrace();
		throw new ImplicitTestFailedException();
	}
	...
	public static void noNPEDuringInvoke(MethodHandle mh, MethodType mt) {
		noNPEDuringInvoke(mh, mt, "");
	}
	
	public static void noNPEDuringInvoke(MethodHandle mh, MethodType mt, String messageSuffix) {
		System.out.println("Invoking " + mh.type() + " as " + mt + " -> did not throw the expected NPE." + messageSuffix);
		throw new ImplicitTestFailedException();
	}
	...
	public static void noClassCastDuringInvoke(MethodHandle mh, MethodType mt, String messageSuffix) {
		System.out.println("Invoking " + mh.type() + " as " + mt + " -> did not throw the expected ClassCastException." + messageSuffix);
		throw new ImplicitTestFailedException();
	}

	public static void noExceptionDuringCast(MethodHandle mh, MethodType mt) {
		System.out.println("Casting " + mh.type() + " to " + mt + " -> did not throw the expected WrongMethodypeException");
		throw new ImplicitTestFailedException();
	}
	...
	public static void testVoid() throws Throwable {
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(I)I", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("()V", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(J)J", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(F)F", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(D)D", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(B)B", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(Z)Z", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(C)C", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(S)S", null));
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;)Ljava/lang/Object;", null));
	...
	public static void testReference() throws Throwable {
		...
		// Unboxing NULL should throw an NPE
		...
		try {
			...
			try {
				...
				noNPEDuringInvoke(s, mt, " The return value was an int with the value of: " + result);
		...
		// Narrowing the reference cast

		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(Ljava/lang/String;)Ljava/lang/Object;", null));
		...
		try {
			...
			try {
				...
				noClassCastDuringInvoke(s, mt, " The return value was an object whose toString value is " + result.toString());
		...
		// Narrowing the reference cast of null
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(Ljava/io/Serializable;)Ljava/lang/Object;", null));
		mt = MethodType.fromMethodDescriptorString("(Ljava/lang/String;)Ljava/lang/Object;", null);
		try {
			c = cast(s, mt);
			try {
		...
		// return - Unboxing NULL should throw an NPE
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "testString", MethodType.fromMethodDescriptorString("(Ljava/lang/String;)Ljava/lang/String;", null));
		mt = MethodType.fromMethodDescriptorString("(Ljava/lang/String;)Ljava/lang/Object;", null);
		try {
			c = cast(s, mt);
			try {
		...
		try {
			...
			try {
				...
				noClassCastDuringInvoke(s, mt,  " The return value was this String: " + result);
			} catch (ClassCastException t) {
				expectedExceptionDuringInvoke(s, mt, t);
			} catch (Throwable t) {
				exceptionDuringInvoke(s, mt, t);
	...
	public static void testConvertInt(int v) throws Throwable {
		...
		s = MethodHandles.lookup().findStatic(StaticAsTypeTestImplicit.class, "test", MethodType.fromMethodDescriptorString("(Ljava/lang/Number;)Ljava/lang/Object;", null));
		try {
			c = cast(s, mt);
			try {
				compare(s, mt, (int)v, ((Integer) (Object)c.invokeExact((int)v)).intValue());
 ...
 *
 */
class ImplicitTestFailedException extends RuntimeException {
