...
public class TestSuite044 extends TestCase
{
  ...
  {
    rc_int = (new BigDecimal("19999999680")).intValue();
    Assert.assertEquals(-1474836800, rc_int);
  }
  public void testItem_0001()
  {
    rc_BigDecimal = (new BigDecimal("1999999968")).plus(new MathContext("precision=1 roundingMode=DOWN"));
  ...
  {
    rc_long = (new BigDecimal("1E+9")).longValueExact();
    Assert.assertEquals(1000000000L, rc_long);
  }
  public void testItem_0005()
  {
    rc_BigDecimal = (new BigDecimal("19999999680")).max(new BigDecimal("19999999680"));
    Assert.assertEquals("19999999680", rc_BigDecimal.toString());
  }
  public void testItem_0006()
  {
    rc_BigDecimal = (new BigDecimal("1E+9")).divide(new BigDecimal("1E+9"), 1);
    Assert.assertEquals("0E+9", rc_BigDecimal.toString());
  }
  public void testItem_0007()
  {
    rc_BigDecimal = (new BigDecimal("1")).subtract(new BigDecimal("1E+9"));
    Assert.assertEquals("-999999999", rc_BigDecimal.toString());
  }
  public void testItem_0008()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1E+9")).divide(new BigDecimal("1"), 2147483647);
    }
  ...
  public void testItem_0009()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1E+9")).setScale(2147483647, -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-999999999")).add(new BigDecimal("1.999999968E+10"));
    Assert.assertEquals("18999999681", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("18999999681")).multiply(new BigDecimal("1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("18999999681", rc_BigDecimal.toString());
  }
  public void testItem_0015()
  {
    rc_BigDecimal = (new BigDecimal("1E+9")).abs(new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("1E+9", rc_BigDecimal.toString());
  }
  public void testItem_0016()
  {
    ...
    caught = false;
    try {
      rc_byte = (new BigDecimal("1.999999968E+10")).byteValueExact();
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_int = (new BigDecimal("18999999681")).compareTo(new BigDecimal("1E+9"));
    Assert.assertEquals(1, rc_int);
  }
  public void testItem_0018()
  {
    rc_BigDecimal = (new BigDecimal("1E+9")).scaleByPowerOfTen(0);
    Assert.assertEquals("1E+9", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0020()
  {
    ...
    Assert.assertEquals("1000000000", rc_BigInteger.toString());
  }
  public void testItem_0021()
  {
    rc_BigDecimal = (new BigDecimal("1.999999968E+10")).max(new BigDecimal("0"));
    Assert.assertEquals("1.999999968E+10", rc_BigDecimal.toString());
  }
  public void testItem_0022()
  {
    rc_BigDecimal = (new BigDecimal("1.999999968E+10")).scaleByPowerOfTen(-1);
  ...
  {
    rc_BigDecimal = (new BigDecimal("1999999968")).min(new BigDecimal("1E+9"));
    Assert.assertEquals("1E+9", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1.999999968E+10")).negate(new MathContext("precision=0 roundingMode=UNNECESSARY"));
    Assert.assertEquals("-1.999999968E+10", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigInteger = (new BigDecimal("1.999999968E+10")).toBigIntegerExact();
    Assert.assertEquals("19999999680", rc_BigInteger.toString());
  }
...
//  {
//    boolean caught;
//    rc_int = (new BigDecimal("300")).hashCode();
//    Assert.assertEquals(9300, rc_int);
//  }
...
//    caught = false;
//    try {
//      rc_BigDecimal_array = (new BigDecimal("1E+9")).divideAndRemainder(new BigDecimal("1E+9"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
//    }
//    catch (java.lang.ArithmeticException e) {
//      caught = true;
//    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("300"), -2147483648, java.math.RoundingMode.UNNECESSARY);
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("32")).divide(new BigDecimal("3E+1"), 1);
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1")).remainder(new BigDecimal("1E+9"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0048()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("W:CWBU7IV@1J00=AN3U:I18BG:OO6EFSWGWYMLJF;21>XOY>DXOT5WEMVX3:U2PT8D");
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//  }
  ...
  {
    rc_boolean = (new BigDecimal("3E+1")).equals(":EG?HTWDLO93QWEFN59KTG;2SENCV=:=>063<X<W?Q8X?E5U=ATKL1VWHBT<AWW>R56TXB@<>FD6@XWOBR??;8KPUDTE1XF2O6DF");
  ...
  public void testItem_0064()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("XGBJN=;?80L5RXCESTHDT28POUBXQ6YMN<TFJBO>4X>GT;BUSFBOB6XUJFEUGUBA;?IA=CSLJDXNIS:A1I3<<4>HRR>YYND>1DW:");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0065()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1', '8', '\1', '8', '\234', '\1', '\234', '\1', '\1', '\uFFFF', '\0', '\234', '\uFFFF', '\0', '\1', '8', '\1', '\0', '8', '8', '\uFFFF', '\0', '\uFFFF', '\1', '\uFFFF', '\234', '\uFFFF', '8', '\0', '\uFFFF', '\234', '\234', '\1', '\0', '\234', '\uFFFF', '\234', '\uFFFF', '\0', '\234', '\234', '\234', '8', '\0', '\uFFFF', '\uFFFF', '8', '\1', '\234', '8', '\1', '\0', '8', '\1', '\1', '8', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '8', '\uFFFF'}, -1, 2147483647);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("33")).multiply(new BigDecimal("1"), new MathContext("precision=0 roundingMode=UNNECESSARY"));
    Assert.assertEquals("33", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1")).subtract(new BigDecimal("33"));
    Assert.assertEquals("-32", rc_BigDecimal.toString());
  }
  public void testItem_0078()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '8', '\234', '8', '\uFFFF', '\1', '\uFFFF', '\234', '\1', '\uFFFF', '\1', '\0', '\234', '\1', '\1', '\uFFFF', '\234', '\234', '\1', '\1', '8', '\uFFFF', '\234', '\1', '\uFFFF', '8', '\234', '\0', '\234', '\uFFFF', '\0', '\234', '8', '8', '\0', '\234', '\234', '\uFFFF', '\234', '8', '\234', '8', '\1', '\uFFFF', '8', '\234', '\1', '\0', '\1', '\0', '\0', '\234', '\uFFFF', '\uFFFF', '\0', '\1', '\0', '\234', '\uFFFF', '8', '\1', '\uFFFF', '\234', '\0', '\1', '8', '\uFFFF', '\234', '\234', '\234', '\uFFFF', '\uFFFF', '8', '8', '\234', '8', '\1', '\0', '\234', '8', '8', '\1', '8', '\uFFFF', '\1', '8', '8', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '8', '\0', '\234', '\0', '\234', '\0', '\1', '\1', '\234'}, 1, -1);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("33")).max(new BigDecimal("-3E+1"));
    Assert.assertEquals("33", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+1")).add(new BigDecimal("33"));
    Assert.assertEquals("3", rc_BigDecimal.toString());
  }
  public void testItem_0084()
  {
    rc_BigDecimal = (new BigDecimal("3")).multiply(new BigDecimal("-32"), new MathContext("precision=1 roundingMode=HALF_UP"));
...
//    caught = false;
//    try {
//      rc_BigDecimal_array = (new BigDecimal("33")).divideAndRemainder(new BigDecimal("-32"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
//    }
//    catch (java.lang.ArithmeticException e) {
//      caught = true;
//    }
...
//  }
  ...
  public void testItem_0089()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1', '\uFFFF', '\uFFFF', '\234', '\1', '\uFFFF', '\1', '\234', '\234', '\234', '\0', '\234', '\234', '8', '\234', '8', '8', '8', '\1', '\1', '\0', '\1', '8', '\1', '\uFFFF', '\uFFFF', '\1', '\0', '\234', '8', '\1', '\234', '\1', '\0', '\234', '\0', '8', '\uFFFF', '\1', '8', '\1', '\234', '8', '\0', '\234', '\uFFFF', '\0', '8', '\234', '\1', '\uFFFF', '\234', '\0', '\234', '\234', '8', '\1', '\234', '\234', '\uFFFF', '\0', '\1', '\0', '\uFFFF', '\1', '\234', '\uFFFF', '\1', '\0', '8', '8', '\0', '8', '\0', '\1', '\0', '\uFFFF', '\1', '\0', '\234', '8', '\0'}, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("8")).divideToIntegralValue(new BigDecimal("-32"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+1")).multiply(new BigDecimal("-32"), new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("9.6E+2", rc_BigDecimal.toString());
  }
  public void testItem_0097()
  {
    rc_BigDecimal_array = (new BigDecimal("8")).divideAndRemainder(new BigDecimal("-"));
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0")).subtract(new BigDecimal("-"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9.6E+2")).plus(new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("9.6E+2", rc_BigDecimal.toString());
  }
  public void testItem_0104()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\uFFFF', '\1', '\uFFFF', '\234', '\0', '\uFFFF', '\234', '8', '\234', '\1', '\0', '\uFFFF', '\234', '\234', '8', '\1', '\uFFFF', '8', '\uFFFF', '8', '\uFFFF', '\0', '\uFFFF', '\1', '8', '\0', '8', '\0', '\234', '\uFFFF', '8', '\234', '\234', '\uFFFF', '\234', '\uFFFF', '\uFFFF', '8', '\1', '\234', '\234', '\0', '\uFFFF', '\uFFFF', '8', '8', '\1', '\0', '\1', '\1', '8', '\0', '8', '8', '8', '8'}, 2147483647, 1, new MathContext("precision=0 roundingMode=FLOOR"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9.6E+2")).plus(new MathContext("precision=0 roundingMode=UNNECESSARY"));
    Assert.assertEquals("9.6E+2", rc_BigDecimal.toString());
  }
  public void testItem_0107()
  {
    rc_BigDecimal_array = (new BigDecimal("8")).divideAndRemainder(new BigDecimal("9.6E+2"));
  }
...
//  }
  ...
  public void testItem_0118()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("GHV1?>DBLRBAKWN38T1IA6921OR<B6KRPU:@D7JVYNBNOSQ0MDKOGTHEMDXM", new MathContext("precision=1 roundingMode=DOWN"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_int = (new BigDecimal("8")).compareTo(new BigDecimal("0"));
    Assert.assertEquals(1, rc_int);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("8")).subtract(new BigDecimal("0"));
    Assert.assertEquals("8", rc_BigDecimal.toString());
  }
...
//  }
  ...
  {
    rc_boolean = (new BigDecimal("32")).equals(":6S9IY?@KK14W2QLU5>CG??HYTO?I1WY>CXB1QDSI3X853C75");
    Assert.assertEquals(false, rc_boolean);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("8")).subtract(new BigDecimal("32"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("-24", rc_BigDecimal.toString());
  }
  public void testItem_0138()
  {
    rc_float = (new BigDecimal("-24")).floatValue();
    Assert.assertEquals(-24.0F, rc_float, 0);
  }
  ...
  public void testItem_0142()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0")).divide(new BigDecimal("0"), -1, java.math.RoundingMode.HALF_DOWN);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("32")).remainder(new BigDecimal("-24"));
    Assert.assertEquals("8", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0147()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '\1', '\1', '\0', '8', '\234', '8', '8', '\1', '\234', '8', '\0', '8', '\0', '8', '\234', '\1', '8', '\0', '\1', '\1', '\0', '8', '8', '\234', '\1', '8', '\1', '\0', '\uFFFF', '\uFFFF', '\234', '8', '8', '\uFFFF', '8', '\0', '\uFFFF', '\234', '\1', '8', '8', '\uFFFF', '\234', '\uFFFF', '\1', '\0', '\uFFFF', '8', '\uFFFF', '\1', '\1', '\uFFFF', '\uFFFF', '\uFFFF', '\0', '8', '\234', '\uFFFF', '\1', '8', '\1', '\234', '8', '\0', '\0', '\1', '8', '8', '\234', '\uFFFF', '\234', '\234', '\234', '\1', '8', '\234', '\uFFFF', '\234', '\uFFFF', '8', '\0', '\1', '\0', '8', '\1', '\1', '\0', '\0', '\1', '8', '\234', '\0', '\234', '\uFFFF', '8', '\0', '\0', '\uFFFF', '\0'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0151()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '\234', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '8', '\0', '\234', '8', '\uFFFF', '\uFFFF', '8', '8', '\uFFFF', '8', '\0', '\1', '\1', '\234', '\0', '\1', '\234', '\uFFFF', '\1', '\uFFFF', '\234', '\uFFFF', '8', '\1', '\234', '\1', '\1', '\1', '\uFFFF', '\uFFFF', '\uFFFF', '\234', '\1', '\1', '\0', '8', '\uFFFF', '\uFFFF', '\234', '\1', '\uFFFF', '\uFFFF', '8', '\234', '8', '\234', '\234', '\234', '\uFFFF', '\uFFFF', '\0', '\1', '\234', '\1', '\0', '\0', '\1', '8', '\234', '\234', '\0', '\0', '\0', '8', '\234', '\uFFFF', '8', '8'}, new MathContext("precision=1 roundingMode=DOWN"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-24")).abs();
    Assert.assertEquals("24", rc_BigDecimal.toString());
  }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).round(new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  public void testItem_0158()
  {
    rc_BigDecimal = (new BigDecimal("24")).divide(new BigDecimal("3E+1"), 0, 1);
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0E+1")).remainder(new BigDecimal("3E+1"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0E+1", rc_BigDecimal.toString());
  }
  public void testItem_0161()
  {
    rc_BigDecimal = (new BigDecimal("0E+1")).divideToIntegralValue(new BigDecimal("3E+1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0163()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '8', '\0', '8', '\0', '\0', '\0', '\uFFFF', '\0', '8', '\uFFFF', '\1', '\234', '8', '\234', '\1', '\1', '\0', '8', '\0', '8', '8', '\234', '\uFFFF', '8', '\1', '\uFFFF', '8', '8', '\1', '\0', '\234', '\1', '\1', '\1', '\0', '\234', '\234', '\uFFFF', '8', '\234', '\0', '8', '8', '8', '\uFFFF', '\0', '\1', '\uFFFF', '\0', '\1', '\1', '\234', '\uFFFF', '\uFFFF', '8', '8', '\0', '8', '\0', '\0', '\234', '\234', '\1', '8', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '\1', '\uFFFF', '\0', '\234', '8', '\1', '8', '\234', '\1', '\1', '\1', '8', '8', '\uFFFF', '\1', '\uFFFF', '8', '8', '8', '\1', '8', '\uFFFF', '\uFFFF', '\1', '\1', '\234', '\0', '\234', '\234', '8', '\1'}, 0, -2147483648, new MathContext("precision=0 roundingMode=FLOOR"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0")).min(new BigDecimal("-24"));
    Assert.assertEquals("-24", rc_BigDecimal.toString());
  }
  ...
  {
    rc_boolean = (new BigDecimal("0")).equals("E2A3J0=@M6T6B8;4KB4LOC79?PE;TCUKL=NK3XRHXK@XRN@O?EM1AP2=GTWBJY;8RT3X2Y37ICROVCT5DA342RM0O10GUVECOJUV");
    Assert.assertEquals(false, rc_boolean);
  }
...
//  }
  ...
  public void testItem_0180()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal_array = (new BigDecimal("0")).divideAndRemainder(new BigDecimal("0E+1"), new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).multiply(new BigDecimal("3E+1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
  ...
  public void testItem_0187()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("9E+2")).divide(new BigDecimal("0E+1"), java.math.RoundingMode.CEILING);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).add(new BigDecimal("9E+2"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("9E+2", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9E+2")).remainder(new BigDecimal("9E+2"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0E+2", rc_BigDecimal.toString());
  }
  public void testItem_0192()
  {
    rc_long = (new BigDecimal("9E+2")).longValue();
    Assert.assertEquals(900L, rc_long);
  }
  ...
  {
    rc_BigInteger = (new BigDecimal("9E+2")).toBigIntegerExact();
    Assert.assertEquals("900", rc_BigInteger.toString());
  }
  public void testItem_0198()
  {
    rc_BigDecimal = (new BigDecimal("0E-2147483646")).add(new BigDecimal("0E+2"), new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("0E-2147483646", rc_BigDecimal.toString());
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("-2147483648")).setScale(2147483647);
//    }
//    catch (java.lang.NegativeArraySizeException e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-2147483648")).divideToIntegralValue(new BigDecimal("9E+2"));
    Assert.assertEquals("-2386092.00", rc_BigDecimal.toString());
  }
  public void testItem_0201()
  {
    rc_BigDecimal_array = (new BigDecimal("-2147483648")).divideAndRemainder(new BigDecimal("3E+1"));
  }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-2386092.00")).divide(new BigDecimal("-2386092.00"), java.math.RoundingMode.UNNECESSARY);
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).multiply(new BigDecimal("-2147483648"));
    Assert.assertEquals("-6.442450944E+10", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0208()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(">BU3XSK9YFLTM36P115AR?PQ<FE1W37R3SR7A9XV>J:I9SMLN73N:EH20IWQXPPXLS0O34MLD6=V8<F0?BR2VATSJWRJSYYVVV8S", new MathContext("precision=1 roundingMode=DOWN"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("3E+1")).divideAndRemainder(new BigDecimal("-21474836480"));
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+308")).divide(new BigDecimal("2E+308"), new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_int = (new BigDecimal("1")).compareTo(new BigDecimal("2E+308"));
    Assert.assertEquals(-1, rc_int);
  }
  public void testItem_0214()
  {
    rc_BigDecimal = (new BigDecimal("0.0")).divide(new BigDecimal("1"), java.math.RoundingMode.UNNECESSARY);
    Assert.assertEquals("0.0", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.0")).add(new BigDecimal("0.1"));
    Assert.assertEquals("0.1", rc_BigDecimal.toString());
  }
  public void testItem_0219()
  {
    rc_BigDecimal = (new BigDecimal("0.1")).max(new BigDecimal("0.0"));
    Assert.assertEquals("0.1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0221()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("0WV>233CMRJ4@4LV0NPQWDLQ2J79VN@");
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.0")).remainder(new BigDecimal("4.-324"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0.0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0228()
  {
    ...
    Assert.assertEquals("9E-324", rc_BigDecimal.toString());
  }
  public void testItem_0229()
  {
    rc_BigDecimal = (new BigDecimal("9E-324")).multiply(new BigDecimal("4.-324"), new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("4.-647", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("4.-324")).divideToIntegralValue(new BigDecimal("4.-647"), new MathContext("precision=0 roundingMode=FLOOR"));
    Assert.assertEquals("", rc_BigDecimal.toString());
  }
  public void testItem_0234()
  {
    rc_int = (new BigDecimal("4.-647")).scale();
    Assert.assertEquals(1398, rc_int);
  }
  public void testItem_0235()
  {
    rc_int = (new BigDecimal("4.-647")).compareTo(new BigDecimal("9E-324"));
    Assert.assertEquals(-1, rc_int);
  }
  ...
  public void testItem_0239()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("4.-324")).divide(new BigDecimal("0E-324"), new MathContext("precision=1 roundingMode=DOWN"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+308")).max(new BigDecimal("-1"));
    Assert.assertEquals("2E+308", rc_BigDecimal.toString());
  }
  public void testItem_0241()
  {
    rc_float = (new BigDecimal("0E-324")).floatValue();
    Assert.assertEquals(0.0F, rc_float, 0);
  }
  public void testItem_0242()
  {
    rc_BigDecimal_array = (new BigDecimal("4.-647")).divideAndRemainder(new BigDecimal("4.-324"));
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0E-324")).divide(new BigDecimal("4.-324"), 0);
    Assert.assertEquals("0E-324", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0E-324")).pow(0);
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
...
//  {
//    boolean caught;
//    rc_int = (new BigDecimal("0E-324")).hashCode();
...
//  }
  public void testItem_0250()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext(";;<MD@MEK2359TVR9@1=6HQ<?>RAQS7>L49?E>8DGWEW1P@J7?C391QUGQ4P5?5QO1P=UNEAB72JMNCKLBSIW9<37UHF;ENR3G1@");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+308")).round(new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("2E+308", rc_BigDecimal.toString());
  }
...
//  {
//    boolean caught;
//    rc_BigDecimal_array = (new BigDecimal("320.0E+2147483647")).divideAndRemainder(new BigDecimal(""), new MathContext("precision=1 roundingMode=DOWN"));
//  }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+308")).negate(new MathContext("precision=1 roundingMode=UNNECESSARY"));
    Assert.assertEquals("-2E+308", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+308")).remainder(new BigDecimal(""), new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("", rc_BigDecimal.toString());
  }
...
//  }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("-2E+308")).divideAndRemainder(new BigDecimal("-1"));
  }
  public void testItem_0278()
  {
    rc_BigDecimal = (new BigDecimal("-2E+308")).add(new BigDecimal("-"), new MathContext("precision=1 roundingMode=DOWN"));
  ...
  public void testItem_0279()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("2E+308")).movePointLeft(-2147483648);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-2E+308")).subtract(new BigDecimal("-3E+308"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
...
//  }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("0")).divideAndRemainder(new BigDecimal("-"), new MathContext("precision=1 roundingMode=DOWN"));
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+308")).round(new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("-3E+308", rc_BigDecimal.toString());
  }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+308")).divide(new BigDecimal("-3E+308"), java.math.RoundingMode.CEILING);
    Assert.assertEquals("1E+308", rc_BigDecimal.toString());
  }
  public void testItem_0289()
  {
    ...
    caught = false;
    try {
      rc_long = (new BigDecimal("-3E+308")).longValueExact();
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0294()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("-2E+308")).divide(new BigDecimal("1E+308"), 2147483647, -1);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0295()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0")).divide(new BigDecimal("1E+308"), -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0299()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1E+308")).movePointRight(2147483647);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("-3E+308")).divideAndRemainder(new BigDecimal("-3E+308"));
  }
  ...
  public void testItem_0302()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("-3E+308")).setScale(1, 2147483647);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0303()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1E+308")).divide(new BigDecimal("-3E+308"), -2147483648, java.math.RoundingMode.UNNECESSARY);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+308")).pow(0);
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  public void testItem_0305()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("9223372036854775807")).abs(new MathContext("precision=1 roundingMode=UNNECESSARY"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1E+308")).scaleByPowerOfTen(1);
  ...
  {
    rc_BigDecimal = (new BigDecimal("1")).negate(new MathContext("precision=1 roundingMode=UNNECESSARY"));
    Assert.assertEquals("-1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("1E+308")).divideAndRemainder(new BigDecimal("1"));
  }
  public void testItem_0316()
  {
    rc_BigDecimal = (new BigDecimal("-1")).divide(new BigDecimal("1"), new MathContext("precision=1 roundingMode=UNNECESSARY"));
    Assert.assertEquals("-1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-1")).remainder(new BigDecimal("-1"), new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0323()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("=EIHRMP?W1JGO8NVOKPP3DY;CDIFQG=JDIF;70IWT0EY4QHX640SUE<TP:LYH=Y@H92W61R0ATKM9;Q58SNY5O<K5I57UXRSYAIU", new MathContext("precision=1 roundingMode=UNNECESSARY"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//  }
  ...
  public void testItem_0328()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("-1")).divide(new BigDecimal("1"), -2147483648, java.math.RoundingMode.HALF_EVEN);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("10"), new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("3", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3")).divide(new BigDecimal("3E+1"), 1);
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0342()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '\1', '\0', '\234', '\uFFFF', '\1', '8', '\uFFFF', '\uFFFF', '\0'}, -2147483648, -2147483648);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.00")).negate(new MathContext("precision=1 roundingMode=UNNECESSARY"));
    Assert.assertEquals("0.00", rc_BigDecimal.toString());
  }
...
//  }
  ...
  public void testItem_0359()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext(">4HF7CCX@MLQTH=<TB5J5V78F6>>:99DBAT5ULRI");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//  }
  ...
  public void testItem_0367()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("?@R82C<Y;81HMHIF>=PA840QH5T9AYKF80MUW;HUE@R?;T0L5E8=9H?TW1VREJS0HYB91NJ;HX=6C@?:W7>WCY90ILJL>B@406Q1");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0379()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal_array = (new BigDecimal("1")).divideAndRemainder(new BigDecimal("0.00"), new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0380()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1")).divideToIntegralValue(new BigDecimal("0.00"), new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0385()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '\uFFFF', '\uFFFF', '8', '\234', '\1', '8', '\0', '\234', '\0', '\234', '\234', '\0', '\uFFFF', '8', '8', '\1', '\234', '\1', '\234', '8', '\1', '\1', '\0', '\0', '\1', '\uFFFF', '8', '8', '8', '8', '\234', '\0', '\uFFFF', '\1', '\uFFFF', '\1', '\234', '\uFFFF', '\uFFFF', '8', '8', '\234', '8', '\uFFFF', '\uFFFF', '\1', '\0', '\0', '8', '\1', '8', '\234', '\0', '8', '\1', '8', '8', '\234', '\234', '8', '\uFFFF', '\0', '\0', '8', '\uFFFF', '8', '\uFFFF', '\uFFFF', '8', '8'}, new MathContext("precision=1 roundingMode=UNNECESSARY"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0387()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '8', '\1', '\uFFFF', '\1', '\234', '\1', '\234', '\uFFFF', '\0', '\234', '\uFFFF', '\0', '\234', '\0', '\uFFFF', '\234', '\234', '\1', '\0', '\1', '\234', '8', '8', '8', '\234', '\uFFFF', '\0', '\234', '\1', '\uFFFF', '\uFFFF', '\uFFFF', '\0', '8', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '\uFFFF', '\0', '\0', '\234', '\234', '\1', '\uFFFF', '\0', '\uFFFF', '\234', '\uFFFF', '\234', '\1', '8', '8'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0390()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("MHJ3XLQDT3K@H=:@C1BEID:@J=6@FK;8=ELH35:DC>6CIIXFV@M@5GA@BKA;9M9<2PB2=Q2>P:E<@XSJSV6@YG60=GKWD=>AA>TI");
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.00")).min(new BigDecimal("0E-2147483647"));
    Assert.assertEquals("0.00", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.00")).multiply(new BigDecimal("0"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0.00", rc_BigDecimal.toString());
  }
  public void testItem_0403()
  {
    rc_BigDecimal = (new BigDecimal("0.00")).setScale(-1, java.math.RoundingMode.HALF_DOWN);
    Assert.assertEquals("0E+1", rc_BigDecimal.toString());
  }
  public void testItem_0404()
  {
    rc_BigDecimal = (new BigDecimal("1.0")).divide(new BigDecimal("-1"), java.math.RoundingMode.HALF_DOWN);
    Assert.assertEquals("-1.0", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-1.0")).pow(1, new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("-1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0418()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal_array = (new BigDecimal("0E+1")).divideAndRemainder(new BigDecimal("0E+1"), new MathContext("precision=1 roundingMode=DOWN"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0422()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("-1.0")).divide(new BigDecimal("0E+1"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("4E-324")).plus();
    Assert.assertEquals("4E-324", rc_BigDecimal.toString());
  }
  public void testItem_0425()
  {
    rc_BigDecimal = (new BigDecimal("4E-324")).add(new BigDecimal("4E-324"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("8E-324", rc_BigDecimal.toString());
  }
  public void testItem_0426()
  {
    rc_BigDecimal = (new BigDecimal("4E-324")).negate(new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("-4E-324", rc_BigDecimal.toString());
  }
  ...
  {
    rc_int = (new BigDecimal("8E-324")).signum();
    Assert.assertEquals(1, rc_int);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("4E-324")).divide(new BigDecimal("8E-324"), 0, java.math.RoundingMode.CEILING);
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_int = (new BigDecimal("4E-324")).precision();
    Assert.assertEquals(1, rc_int);
  }
//  public void testItem_0435()
//  {
//    boolean caught;
//    rc_int = (new BigDecimal("8E-324")).hashCode();
//    Assert.assertEquals(572, rc_int);
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("4E-324")).divideToIntegralValue(new BigDecimal("8E-324"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("4E-324")).divideToIntegralValue(new BigDecimal("-0.9"), new MathContext("precision=1 roundingMode=DOWN"));
  ...
  {
    rc_int = (new BigDecimal("8E-324")).compareTo(new BigDecimal("4E-324"));
    Assert.assertEquals(1, rc_int);
  }
  @SuppressWarnings("unlikely-arg-type")
  public void testItem_0442()
  {
    rc_boolean = (new BigDecimal("0E-323")).equals("");
    Assert.assertEquals(false, rc_boolean);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0E-323")).abs(new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0E-323", rc_BigDecimal.toString());
  }
  @SuppressWarnings("unlikely-arg-type")
  public void testItem_0446()
  {
    rc_boolean = (new BigDecimal("-0.9")).equals("");
    Assert.assertEquals(false, rc_boolean);
  }
  public void testItem_0447()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '8', '\uFFFF', '8', '8', '\234', '\1', '8', '8', '8', '\234', '8', '\uFFFF', '\0', '\0', '\1', '\234', '\1', '\uFFFF', '\234', '8', '\0', '\1'}, 2147483647, 0, new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0448()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("4E-324")).setScale(1);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0449()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0E-323")).divide(new BigDecimal("0E-323"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0455()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1', '\0', '\uFFFF', '\0', '\1', '\0', '\234', '\234', '\uFFFF', '\uFFFF', '8', '\uFFFF', '\1', '\1', '\1', '8', '8', '8', '\234', '\0', '\234', '\1', '8', '8', '8', '\234', '\1', '8', '8', '8', '\1', '\1', '\234', '\0', '\1', '\0'}, 2147483647, 2147483647);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_String = (new BigDecimal("4E-324")).toPlainString();
    Assert.assertEquals("0.", rc_String);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-0.9")).subtract(new BigDecimal("4E-324"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("-0.9", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0467()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divideToIntegralValue(new BigDecimal("-0.9"), new MathContext("precision=1 roundingMode=UNNECESSARY"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3.2")).divide(new BigDecimal("3E+1"), 1);
    Assert.assertEquals("0.1", rc_BigDecimal.toString());
  }
  public void testItem_0469()
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).plus(new MathContext("precision=1 roundingMode=DOWN"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_int = (new BigDecimal("-9E+18")).compareTo(new BigDecimal("0.1"));
    Assert.assertEquals(-1, rc_int);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("10")).abs(new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("10", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0483()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '\0', '\0', '8', '\uFFFF', '\1', '\uFFFF', '\uFFFF', '8', '\234', '\0', '\0', '\0', '8', '8', '\1', '\uFFFF', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '\uFFFF', '\1', '\0', '8', '8', '\1', '\1', '8', '\0', '\0', '\234', '\uFFFF', '\234', '\uFFFF', '\234', '\0', '\1', '8', '\0', '8', '\uFFFF', '8', '8', '8', '\234', '\1', '\234', '\234', '\1', '\234', '\0', '\234', '\0', '8', '\0', '8', '\1', '\234', '\1', '\uFFFF', '8', '\1', '\234', '\0', '8', '\uFFFF', '\1', '8', '\1', '\0', '\234', '\0', '\234', '\1', '\1', '\0', '\0', '\1', '\1', '\1', '\uFFFF', '\1', '8', '\0', '\0', '\uFFFF', '\1', '\234', '\234', '\234', '\234', '\0', '8', '\0', '\1', '\234', '\uFFFF', '\0', '\234'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0484()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0.1")).divide(new BigDecimal("0.1"), 2147483647, -1);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("10")).movePointRight(-1);
    Assert.assertEquals("1.0", rc_BigDecimal.toString());
  }
...
//  }
  ...
  public void testItem_0494()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("10")).divide(new BigDecimal("10"), 2147483647);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_String = (new BigDecimal("30")).toPlainString();
    Assert.assertEquals("30", rc_String);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0")).multiply(new BigDecimal("10"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0507()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("D=>1DVWS6");
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0508()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal_array = (new BigDecimal("5E-324")).divideAndRemainder(new BigDecimal("0"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0509()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '\uFFFF', '\0', '\234', '8', '\0', '\234', '\0', '\0', '8', '\1', '\234', '\1', '8', '\0', '\234', '\uFFFF', '\0', '\1', '\0', '\0', '\1', '\234', '\1', '8', '\uFFFF', '\uFFFF', '\0', '\234', '8', '\uFFFF', '\0', '\uFFFF', '\0', '\uFFFF', '\234', '\1', '\0', '8', '\0', '\0', '\0', '8', '8', '\1', '\1', '\uFFFF', '8', '\234', '8', '\0', '\uFFFF', '\234', '\uFFFF', '\234', '\234', '8', '\1', '\234', '8', '\0', '8', '\uFFFF', '\0', '\1', '8', '\234', '\uFFFF', '\0', '\1', '\0', '\234', '\uFFFF', '\0', '\0', '\uFFFF', '8', '8', '8', '\234', '\uFFFF', '\0', '\1', '\uFFFF', '8', '\1', '\234', '\1', '\234', '8', '8', '\234', '8', '\1', '\uFFFF', '\uFFFF', '8', '\1', '\234', '\1'}, -1, -2147483648);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0510()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '\234', '8', '\234', '8', '\234', '\1', '\234', '\234', '\234', '8', '8', '\234', '\uFFFF', '\0', '\uFFFF', '\1', '\0', '\1', '\0', '\0', '\uFFFF', '\uFFFF', '\234', '\234', '\234', '\0', '\1', '\uFFFF', '\0', '\uFFFF', '\1', '\234', '8', '\uFFFF', '8', '\0', '8', '\234', '\uFFFF', '\uFFFF', '\0', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '\234', '\1', '\0', '8', '\0', '8', '\234', '\0'}, 0, 2147483647);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0514()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '\234', '\234', '\1', '\uFFFF', '\234', '\uFFFF', '\1', '\234', '\uFFFF', '\uFFFF', '\uFFFF', '\uFFFF', '\1', '\0', '\234', '\uFFFF', '\uFFFF', '\uFFFF', '\1', '\0', '\1', '\234', '\0', '\1', '\234', '\1', '\uFFFF', '\1', '\0', '\uFFFF', '\1', '\1', '\0', '8', '\uFFFF', '\uFFFF', '\1', '\0', '\uFFFF', '8', '\234', '\0', '\1', '8', '\1', '\uFFFF', '\1', '\234', '\1', '\1', '\uFFFF', '\1', '\234', '\uFFFF', '\uFFFF', '8', '\234', '\234', '\0', '\234', '\0', '8', '\234', '\234', '\0', '\1', '\234', '\0', '\1', '8', '8', '\1', '\234', '\uFFFF', '\0', '\1', '\234', '\uFFFF', '8', '\234', '\234', '\234', '\234', '\1', '\0', '\uFFFF', '\0', '\uFFFF', '\1', '\234', '\1', '8', '\uFFFF', '\uFFFF', '\0', '8', '\uFFFF', '\1', '\1'}, 2147483647, 1, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).multiply(new BigDecimal("3E-647"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("9E-646", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9E-646")).pow(1, new MathContext("precision=1 roundingMode=UNNECESSARY"));
    Assert.assertEquals("9E-646", rc_BigDecimal.toString());
  }
  public void testItem_0529()
  {
    rc_BigDecimal = (new BigDecimal("1")).add(new BigDecimal("9E-646"));
    Assert.assertEquals("1.", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9E-646")).movePointLeft(1);
    Assert.assertEquals("9E-647", rc_BigDecimal.toString());
  }
  public void testItem_0533()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("9E-646")).pow(1, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0534()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("9E-647")).divide(new BigDecimal("3E+1"), java.math.RoundingMode.UNNECESSARY);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0535()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1")).divide(new BigDecimal("9E-647"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_float = (new BigDecimal("9E-647")).floatValue();
    Assert.assertEquals(0.0F, rc_float, 0);
  }
  public void testItem_0537()
  {
    rc_int = (new BigDecimal("9E-647")).precision();
    Assert.assertEquals(1, rc_int);
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("1")).subtract(new BigDecimal("9E-647"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
//    }
...
//  }
  public void testItem_0548()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '\0', '\0', '\234', '\1', '\234', '\uFFFF', '\1', '\uFFFF', '\1', '\uFFFF', '\234', '\0', '\0', '\1', '\0', '\234', '\234', '\234', '\0', '\0', '\uFFFF', '\1', '\0', '\uFFFF', '\1', '8'}, -1, -1, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0550()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("0JL4R4P7O312IGM2A?RK2D48T8W=JKO5TMTDMN35IXK51UHTP@@WC0BFSPX", new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0552()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '\234', '\uFFFF', '\1', '\234', '\1', '\1', '\234', '8'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_boolean = (new BigDecimal("3E+1")).equals("96NPKGM<WN8POM0X?0VTB>WRC;11>TJFX>5>HBR<640@R4X3HVHL6D0>JQJH=00T4OI:4V20W@THAA;GP;GBQDWO<S");
    Assert.assertEquals(false, rc_boolean);
  }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("3E+1")).divideAndRemainder(new BigDecimal("32"));
  }
  ...
  public void testItem_0569()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\uFFFF'}, 0, 0);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("-9E+18")).remainder(new BigDecimal("1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-9E+18")).multiply(new BigDecimal("1"));
    Assert.assertEquals("-9E+18", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-9E+18")).divide(new BigDecimal("3E+1"), 1, 1);
    Assert.assertEquals("-300000000000000000.0", rc_BigDecimal.toString());
  }
...
//  }
  ...
  {
    rc_BigInteger = (new BigDecimal("-300000000000000000.0")).unscaledValue();
    Assert.assertEquals("-3000000000000000000", rc_BigInteger.toString());
  }
  public void testItem_0583()
  {
    rc_BigDecimal = (new BigDecimal("-1")).multiply(new BigDecimal("3E+1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("-3E+1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0585()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '8', '\234', '8', '\uFFFF', '\0', '8', '\234', '\uFFFF', '\uFFFF', '\1', '\0', '\0', '\0', '\1', '\uFFFF', '\1', '\0', '8', '\0', '\0', '8', '\0', '\0', '\uFFFF', '8', '\1', '\0', '8', '8', '8', '\1', '\234', '8', '8', '\1', '\234', '\uFFFF', '8', '\234', '\1', '\234', '\uFFFF', '\234', '\1', '8', '8', '\1', '8', '\234', '\uFFFF', '8', '\234', '\uFFFF', '\234', '\1', '\234', '\1', '\234', '8', '\234', '\234', '\0', '\1', '\uFFFF', '8', '\uFFFF', '8', '8', '\0', '\0', '8', '\1', '\1', '\1', '8', '\0', '\234', '\0', '8', '\0', '\0', '\234', '\1', '8', '8', '\1', '\0', '\uFFFF', '\0', '8', '\1', '8', '\234', '\234', '\uFFFF', '\0', '\0', '8', '\uFFFF'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0586()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("302NH1");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-300000000000000000.0")).round(new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("-300000000000000000.0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0590()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("4B8MR1XG66P2>6@4I:FWQXJEV93MVJT52YVWQ@=E<30LRA;");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-300000000000000000.0")).max(new BigDecimal("3E+1"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
...
//  }
  ...
  {
    rc_float = (new BigDecimal("-300000000000000000.0")).floatValue();
    Assert.assertEquals(-2.9999999529202483E17F, rc_float, 0);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E-2147483647")).min(new BigDecimal("1E+1"));
    Assert.assertEquals("3E-2147483647", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0608()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1', '\uFFFF', '\uFFFF', '\234', '\0', '\234', '\234', '\234', '\0', '\uFFFF', '\234', '\uFFFF', '\1', '\234', '\0', '\234', '\0', '\1', '\1', '\234', '\uFFFF', '\uFFFF', '\234', '\uFFFF', '\0', '\1', '\234', '8', '8', '\234', '\234', '\234', '\0', '\1', '\0', '\234', '\1', '\234', '\0', '\0', '\0', '\234', '8', '\234', '\234', '\1', '\uFFFF', '\uFFFF', '\234', '\0', '\1', '8', '\0', '\uFFFF', '\1', '\uFFFF', '\uFFFF', '\1', '\1', '\1', '8', '\1', '\234', '\0', '\uFFFF', '\0', '\uFFFF', '\uFFFF', '\0', '\1', '\uFFFF', '\234', '\0', '\1', '\0', '\1', '8', '\uFFFF', '8', '\0', '\uFFFF', '\234', '8', '\234', '\1', '\0', '8', '\1', '\234', '\1', '\uFFFF', '\uFFFF', '8', '8', '\uFFFF', '\0', '8', '\uFFFF', '\1', '\234'}, -2147483648, -1, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("-3E+1")).divide(new BigDecimal("-1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+1")).divide(new BigDecimal("-1"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  public void testItem_0613()
  {
    rc_BigDecimal = (new BigDecimal("-3E+1")).multiply(new BigDecimal("-1"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0617()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("-1"), 0, -1);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-6E+1")).divide(new BigDecimal("-1"), java.math.RoundingMode.HALF_UP);
    Assert.assertEquals("6E+1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-3E+1")).divide(new BigDecimal("6E+1"), 1);
    Assert.assertEquals("0E+1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0629()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0")).divide(new BigDecimal("3E+1"), -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0630()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("RGWA;1N81H?P22Y=Y2G6E>CXSTS8RCU9J8LF45>S63L4P@Q39W0O87=IXVO;KBG");
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0641()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\uFFFF', '8', '\0', '\0', '\0', '\1', '\uFFFF', '\1', '\0', '\1', '\234', '\0', '\234', '\1', '8', '\234', '\uFFFF', '\0', '\234', '\0', '8', '\uFFFF', '\234', '\1', '\uFFFF', '\1', '\234', '8', '\uFFFF', '\234', '\1', '\234', '\234', '\1', '\234', '\1', '\234', '\234', '8', '\234', '\0', '\0', '\uFFFF', '8', '\1', '\234', '\234', '\1', '\1', '\1', '\0', '8', '\1', '\1', '8', '8', '\0', '\1', '\0', '\0', '\0', '\234', '8', '8', '\0', '\234', '\0', '\1', '8', '\1', '\uFFFF', '\1', '\0', '\234', '\1', '\234', '\234', '\1', '\1', '\uFFFF', '8', '\0', '\0', '\uFFFF', '\uFFFF', '\0', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '\0', '\0', '8', '\0', '\uFFFF', '8', '\0', '\1'}, new MathContext("precision=0 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0")).add(new BigDecimal("3E+1"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0E+1")).subtract(new BigDecimal("9223372036854775807"));
    Assert.assertEquals("-9223372036854775807", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9223372036854775807")).divide(new BigDecimal("9223372036854775807"), java.math.RoundingMode.UNNECESSARY);
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  public void testItem_0655()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("9223372036854775807")).divideToIntegralValue(new BigDecimal("1"), new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9223372036854775807")).setScale(0, java.math.RoundingMode.CEILING);
    Assert.assertEquals("9223372036854775807", rc_BigDecimal.toString());
  }
  public void testItem_0658()
  {
    rc_BigDecimal = (new BigDecimal("1")).divideToIntegralValue(new BigDecimal("9223372036854775807"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  public void testItem_0659()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1', '8', '\234', '\1', '\0', '\1', '\1', '\234', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '8', '\0', '\0', '\uFFFF', '\0', '\uFFFF', '8', '8', '8', '\0', '\1', '\234', '\234', '\uFFFF', '\234', '\1', '\uFFFF', '\0', '\uFFFF', '\1', '8', '\234', '\1', '\uFFFF', '\0', '\uFFFF', '\234', '8', '\1', '\0', '\0', '\uFFFF', '\uFFFF', '\0', '\0', '8', '\234', '\1', '\1', '8', '\uFFFF', '\234', '8', '\1', '\uFFFF', '\0', '\uFFFF', '8', '\234', '\1', '\234'}, new MathContext("precision=0 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//  }
  ...
  public void testItem_0664()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '\0', '\uFFFF', '\234', '\0', '8', '\uFFFF', '\uFFFF', '\uFFFF', '8', '\1', '\0', '\0', '\1', '\1', '\0', '\0', '8', '\uFFFF', '\1', '\0', '\0'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//  }
  ...
  public void testItem_0693()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0")).divide(new BigDecimal("32"), -1);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0707()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '\uFFFF', '\234', '\0', '\0', '8', '\234', '\0', '\0', '\234', '8', '\0', '\1', '\0', '\234', '\uFFFF', '\uFFFF', '8', '\1', '\1', '\234', '\234', '8', '8', '\234', '\uFFFF', '8', '\234', '\0', '8', '\234', '\0', '\0', '\0', '\1', '\1', '\1', '\1', '\uFFFF', '\1', '\0', '\234', '\1', '8', '\uFFFF', '\0', '\0', '\1', '\uFFFF', '\1', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '\234', '8', '\1', '8', '8', '\uFFFF', '\1', '\0', '\0', '8', '\1', '\1', '8', '\uFFFF', '\uFFFF', '\0', '\0', '8', '\0', '\1', '\234', '8', '8', '\234', '8', '\1', '\234', '\0', '\0', '8', '\1', '\234', '\234', '\uFFFF', '8', '\234', '\234', '\0', '\uFFFF', '\uFFFF', '\1', '\234', '8', '8', '\uFFFF', '8'}, -2147483648, -2147483648);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0709()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '\0', '8', '8', '\0', '\234', '8', '\1', '\234', '\234', '\234', '\uFFFF', '8', '\1', '8', '\0', '\0', '\1', '\0', '\234', '\1', '\234', '\1', '8', '\234', '\1', '\0', '8', '\234', '\uFFFF', '\234', '8', '\uFFFF', '8', '\234', '\0', '\234', '\uFFFF', '\1', '\uFFFF', '\1', '\0', '\1', '\1', '\0', '\234', '\1', '\234', '\1', '8', '\0', '\1', '\1'}, 1, -1);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("3E+1"), 2147483647, java.math.RoundingMode.UP);
//    }
//    catch (java.lang.NegativeArraySizeException e) {
//      caught = true;
//    }
...
//  }
  ...
  public void testItem_0729()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\uFFFF', '\uFFFF', '\234', '\1', '\234', '\234', '\234', '\0', '8', '\234', '\1', '\234', '\1', '\1', '8', '\0', '\1', '\0', '\1', '\0', '\0', '\1', '\0', '\234', '\1', '8', '\0', '\0', '\0', '\uFFFF', '\234', '\234', '\1', '8', '\234', '\234', '\234', '\1', '\234', '\234', '\0', '8', '\uFFFF'}, 0, 2147483647);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0739()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("3E+1"), -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0745()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("0"), java.math.RoundingMode.UNNECESSARY);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).round(new MathContext("precision=2147483647 roundingMode=FLOOR"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3.2")).setScale(0, java.math.RoundingMode.HALF_EVEN);
    Assert.assertEquals("3", rc_BigDecimal.toString());
  }
  public void testItem_0756()
  {
    rc_BigDecimal = (new BigDecimal("3.2")).multiply(new BigDecimal("3E+1"), new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).negate(new MathContext("precision=2147483647 roundingMode=FLOOR"));
    Assert.assertEquals("-3E+1", rc_BigDecimal.toString());
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("-3E+1")).divide(new BigDecimal("3E+1"), 2147483647, java.math.RoundingMode.UNNECESSARY);
//    }
//    catch (java.lang.NegativeArraySizeException e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0")).subtract(new BigDecimal("-3E+1"));
    Assert.assertEquals("30", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0770()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("0"), 2147483647, 2147483647);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//  }
  public void testItem_0772()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("Y1>QMT<E;L0<C7J@S@OKDKG0=;63O9?>74K>F3RI=HYEQDOTLEIEE2OI;>LO@LQV@:VGX;W5AK88C5KNLG4JSSGFD=KV<VE4=JFH");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0")).add(new BigDecimal("-3E+1"));
    Assert.assertEquals("-30", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9E+2")).abs(new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("9E+2", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal_array = (new BigDecimal("0")).divideAndRemainder(new BigDecimal("9E+2"));
  }
  public void testItem_0789()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("-30"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0796()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\0', '\1', '\0', '\uFFFF', '\234', '\0', '\234', '\0', '\uFFFF', '\0', '\0', '\uFFFF', '\0', '8', '\0', '\1', '\uFFFF', '8', '\1', '\uFFFF', '8', '\uFFFF', '\234', '\uFFFF', '8', '\234', '\0', '\234', '\1', '\0', '\uFFFF', '\0', '\1', '\0', '\uFFFF', '8', '\1', '\234', '\234', '\0', '\234', '8', '\1', '\234', '\1', '\234', '\1', '8', '\0', '\1', '\234', '\0', '\0', '\234', '8', '\234', '\0', '\1', '\1', '\1', '\234', '8', '\1', '\234', '8', '8', '\0', '8', '8', '\uFFFF', '8', '\234', '\234', '\1', '\1', '\0', '\234', '\0', '\uFFFF', '8', '\uFFFF', '\0', '\1', '\234', '\1', '\0', '8', '\0', '\0', '8', '\0', '\234', '\uFFFF', '\1', '\uFFFF', '\uFFFF', '\1', '\1', '\uFFFF', '8'}, -1, -1, new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0798()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("SHPX;6XRJXTQ5WVD27Y:1VF1O<;;VTIO7D<FAP6:I3PCLVG1K53FKB7JCQLRIXUODCHDUUG9@JJ?YT3QL6=<44CE3");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_long = (new BigDecimal("9E+2")).longValueExact();
    Assert.assertEquals(900L, rc_long);
  }
  ...
  public void testItem_0803()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("-9223372036854775808")).pow(1, new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3.2E-2147483646")).divide(new BigDecimal("-30"), java.math.RoundingMode.DOWN);
    Assert.assertEquals("-1E-2147483647", rc_BigDecimal.toString());
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("9E+2")).divideToIntegralValue(new BigDecimal("-1E-2147483647"));
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9E+2")).multiply(new BigDecimal("0"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0E+2", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0809()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("9E+2")).divide(new BigDecimal("-9223372036854775808"), -2147483648, 2147483647);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_boolean = (new BigDecimal("-30")).equals("?TIW<5J<PM0C0P74?1V3FRXLVRKXJ9?IA;QT8X=AXT8?6U6V9K8BW:O79K=SW7J>8VEAVQAM2@<FEN5EFMA<MF;GOPH<=W2DM7TU");
    Assert.assertEquals(false, rc_boolean);
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("-9223372036854775808")).divide(new BigDecimal("9E+2"), new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  public void testItem_0820()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("32")).pow(1, new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//  }
  public void testItem_0822()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("32")).divide(new BigDecimal("-1"), -1, 2147483647);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("9E+2")).divide(new BigDecimal("-1"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-9223372036854775808")).negate(new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
    Assert.assertEquals("9223372036854775808", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("9223372036854775808")).divide(new BigDecimal("-9223372036854775808"), java.math.RoundingMode.DOWN);
    Assert.assertEquals("-1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("4.-324")).multiply(new BigDecimal("-1"), new MathContext("precision=1 roundingMode=UP"));
    Assert.assertEquals("-5E-324", rc_BigDecimal.toString());
  }
  public void testItem_0838()
  {
    rc_BigDecimal = (new BigDecimal("-1")).remainder(new BigDecimal("-9223372036854775808"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("-1", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0860()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("<1MLAE@@6JP5:GY:?;GIX@ADQL=I>", new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("-0.03125")).divide(new BigDecimal("-1"));
    Assert.assertEquals("0.03125", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0873()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).divide(new BigDecimal("0.03125"), -1, -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0877()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("3E+1")).setScale(-2147483648, 2147483647);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("0.03125")).movePointLeft(-2147483648);
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).subtract(new BigDecimal("0.03125"), new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    Assert.assertEquals("29.96875", rc_BigDecimal.toString());
  }
  public void testItem_0889()
  {
    rc_int = (new BigDecimal("29.96875")).scale();
  ...
  {
    rc_BigDecimal = (new BigDecimal("29.96875")).setScale(-1, 1);
  ...
  public void testItem_0893()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("2E+1")).pow(1, new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  public void testItem_0894()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("0.03125")).divide(new BigDecimal("0.03125"), 0, -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+1")).movePointRight(1);
  ...
  {
    rc_int = (new BigDecimal("2E+1")).compareTo(new BigDecimal("32"));
    Assert.assertEquals(-1, rc_int);
  }
  public void testItem_0899()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '\0', '\0', '\uFFFF', '\uFFFF', '\0', '\234', '\0', '\234', '\1', '8', '\uFFFF', '\0', '8', '8', '\234', '\234', '\0', '\0', '\0', '\1', '8', '\1', '\0', '\uFFFF', '\234', '\0', '\1', '\uFFFF', '8', '8', '8', '\234', '8', '\234', '\234', '8', '\uFFFF', '8', '\234', '\1', '\uFFFF', '\0', '\234', '\234', '8', '8', '\0'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.03125")).plus(new MathContext("precision=1 roundingMode=HALF_UP"));
  ...
  public void testItem_0904()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("2E+1")).divide(new BigDecimal("320.0E+2147483647"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  public void testItem_0905()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\234', '\uFFFF', '8', '\1', '\234', '\234', '8', '\uFFFF', '\234', '\234', '\234', '\234', '8', '\uFFFF', '\234', '8', '\1', '\uFFFF', '\0', '\234', '8', '\uFFFF', '\0', '\1', '\uFFFF', '\uFFFF', '8', '8', '\0', '\1', '8', '\234', '\1', '8', '\0', '\234', '8', '\1', '\uFFFF', '\0', '\uFFFF', '\234', '\234', '\0', '\1', '8', '\1', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '\uFFFF', '8', '\0', '\0', '8', '\0', '\uFFFF', '8', '\234', '\234', '8', '8', '8', '8', '\1', '\1', '8'}, 0, 1);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigInteger = (new BigDecimal("200")).unscaledValue();
    Assert.assertEquals("200", rc_BigInteger.toString());
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("32")).divide(new BigDecimal("320.0E+2147483647"), 1, java.math.RoundingMode.DOWN);
//    }
//    catch (java.lang.NegativeArraySizeException e) {
//      caught = true;
//    }
...
//  {
//    boolean caught;
//    rc_BigDecimal = (new BigDecimal("320.0E+2147483647")).multiply(new BigDecimal("200"), new MathContext("precision=1 roundingMode=HALF_UP"));
//    Assert.assertEquals("6E-2147483645", rc_BigDecimal.toString());
//  }
  public void testItem_0911()
  {
    rc_BigDecimal = (new BigDecimal("2E+1")).remainder(new BigDecimal("200"), new MathContext("precision=1 roundingMode=UP"));
    Assert.assertEquals("2E+1", rc_BigDecimal.toString());
  }
  public void testItem_0912()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal("AYYKS@GPL5BG=:ID82T@1>", new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("6E-2147483645")).max(new BigDecimal("6E-2147483645"));
    Assert.assertEquals("6E-2147483645", rc_BigDecimal.toString());
  }
  ...
  {
    rc_boolean = (new BigDecimal("200")).equals("");
    Assert.assertEquals(false, rc_boolean);
  }
  public void testItem_0916()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '8', '8', '\1', '\uFFFF', '\0', '\1', '8', '\234', '8', '8', '\234', '\uFFFF', '\1', '\uFFFF', '8', '\0', '\uFFFF', '\1', '\1', '\uFFFF', '\234', '\234', '8', '\0', '\uFFFF', '8', '\0', '8', '8', '8', '8', '\0', '8', '\1', '8', '\1', '8', '8', '8', '8', '\234', '8', '\1', '8', '\0', '\uFFFF', '\0', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '\234', '\0', '\234', '\0', '\uFFFF', '\uFFFF', '\234', '\0', '\uFFFF', '\234', '8', '\0', '\234', '\1', '\234', '\0', '\uFFFF', '\234', '\uFFFF', '\1', '8', '\1', '\uFFFF', '8', '\234', '\1', '\uFFFF', '\1', '\uFFFF', '8', '\234', '\234', '\0', '\1', '\234', '\1', '\1', '\234', '\uFFFF', '\1', '8', '8', '8', '8', '\uFFFF', '8', '8', '\1'}, new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("0.03125")).max(new BigDecimal("200"));
    Assert.assertEquals("200", rc_BigDecimal.toString());
  }
...
//    if (!Boolean.getBoolean("notanerror"))
//    {
//    rc_BigDecimal = (new BigDecimal("320.0E+2147483647")).max(new BigDecimal("6E-2147483645"));
//    Assert.assertEquals("6E-2147483645", rc_BigDecimal.toString());
//    }
//  }
  public void testItem_0919()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("2E+1")).divide(new BigDecimal("200"), 2147483647, -2147483648);
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("320.0E+2147483647")).divide(new BigDecimal("2E+1"), java.math.RoundingMode.DOWN);
//    }
//    catch (java.lang.ArithmeticException e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("2E+1")).multiply(new BigDecimal("0.03125"), new MathContext("precision=1 roundingMode=HALF_UP"));
    Assert.assertEquals("0.6", rc_BigDecimal.toString());
  }
//  public void testItem_0923()
//  {
//    boolean caught;
//    rc_BigDecimal = (new BigDecimal("0.6")).min(new BigDecimal("320.0E+2147483647"));
//    Assert.assertEquals("3.2E+2147483649", rc_BigDecimal.toString());
//  }
  ...
  {
    rc_BigInteger = (new BigDecimal("0.6")).toBigInteger();
    Assert.assertEquals("0", rc_BigInteger.toString());
  }
  public void testItem_0926()
  {
    rc_long = (new BigDecimal("200")).longValueExact();
    Assert.assertEquals(200L, rc_long);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("6E-2147483645")).min(new BigDecimal("200"));
    Assert.assertEquals("6E-2147483645", rc_BigDecimal.toString());
  }
  public void testItem_0931()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8'}, 0, -1, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0932()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("200")).divideToIntegralValue(new BigDecimal("0.6"), new MathContext("precision=1 roundingMode=UP"));
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_long = (new BigDecimal("200")).longValue();
    Assert.assertEquals(200L, rc_long);
  }
  public void testItem_0934()
  {
    rc_int = (new BigDecimal("0.6")).signum();
    Assert.assertEquals(1, rc_int);
  }
  public void testItem_0935()
  {
    rc_int = (new BigDecimal("0.6")).scale();
    Assert.assertEquals(1, rc_int);
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("32")).divide(new BigDecimal("200"));
    Assert.assertEquals("0.16", rc_BigDecimal.toString());
  }
  public void testItem_0939()
  {
    ...
    caught = false;
    try {
      rc_short = (new BigDecimal("0.6")).shortValueExact();
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_String = (new BigDecimal("200")).toEngineeringString();
    Assert.assertEquals("200", rc_String);
  }
  public void testItem_0941()
  {
    rc_BigDecimal = (new BigDecimal("0.16")).divide(new BigDecimal("0.16"));
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  public void testItem_0942()
  {
    rc_int = (new BigDecimal("200")).signum();
    Assert.assertEquals(1, rc_int);
  }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("0.6")).divide(new BigDecimal("320.0E+2147483647"), java.math.RoundingMode.UNNECESSARY);
//    }
//    catch (java.lang.ArithmeticException e) {
//      caught = true;
//    }
...
//  }
  ...
  public void testItem_0946()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'8', '8', '\234', '\0', '8', '\0', '\1', '\uFFFF', '8', '\1', '\uFFFF', '\uFFFF', '\234', '8', '\1', '8', '\0', '\1', '\0', '\234', '\0', '8', '\234', '\234', '\1', '\1', '8', '\234', '\1', '8', '\234', '\234', '\0', '\uFFFF', '\1', '\1', '\0', '\uFFFF', '\234', '8', '8', '\uFFFF', '\1', '\uFFFF', '8', '8', '8', '8', '8', '\234', '\234', '\0', '\0', '\234', '\uFFFF', '\1', '\234', '8', '\1', '\1', '\234', '\234', '\0', '\uFFFF', '\1', '\1', '\uFFFF', '\234', '8', '\1', '\1', '\0', '\234', '\1', '\234', '\1', '\uFFFF', '8', '\234', '\uFFFF', '\0', '\uFFFF', '\uFFFF', '\uFFFF', '\234', '\1', '\234', '8', '\234', '\1', '\234', '\uFFFF', '\0', '\0', '\234', '\1', '\uFFFF', '\1', '\0', '\1'}, new MathContext("precision=2147483647 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("32")).subtract(new BigDecimal("200"));
    Assert.assertEquals("-168", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0955()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1'}, 2147483647, 2147483647);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1E+2147483647")).max(new BigDecimal("-168"));
    Assert.assertEquals("1E+2147483647", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0959()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("-168")).pow(-2147483648);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("32")).divide(new BigDecimal("32"), 2147483647, java.math.RoundingMode.DOWN);
//    }
//    catch (java.lang.NegativeArraySizeException e) {
//      caught = true;
//    }
...
//  }
  ...
  public void testItem_0964()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\1', '\234', '\uFFFF', '\0', '\234', '\234', '\uFFFF', '\1', '\0', '\1', '\0', '\0', '\234', '\234', '\1', '\uFFFF', '\0', '8', '\uFFFF'}, 2147483647, 1);
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0967()
  {
    ...
    caught = false;
    try {
      rc_MathContext = new MathContext("J4YEC>TVV3MK>W0DY9TFY<TB7GR1U9@5P4EIA7HD<6TLVKI19RY?88VDC5;H:LDBV0DVW<G4GEEL6?=8S8<KS8QQ9SPGQY2OA:?D");
    }
    catch (java.lang.IllegalArgumentException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1E+2147483647")).pow(0, new MathContext("precision=1 roundingMode=UP"));
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1")).multiply(new BigDecimal("1"), new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
    Assert.assertEquals("1", rc_BigDecimal.toString());
  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).max(new BigDecimal("30"));
    Assert.assertEquals("3E+1", rc_BigDecimal.toString());
  }
  public void testItem_0981()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("1E+2147483647")).setScale(2147483647, 0);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
...
//    caught = false;
//    try {
//      rc_BigDecimal = (new BigDecimal("32")).divide(new BigDecimal("3E+1"), new MathContext("precision=2147483647 roundingMode=HALF_EVEN"));
//    }
//    catch (java.lang.OutOfMemoryError e) {
//      caught = true;
//    }
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("1E+2147483647")).divide(new BigDecimal("30"), -2147483648, java.math.RoundingMode.HALF_EVEN);
...
//  }
  ...
  {
    rc_BigDecimal = (new BigDecimal("3E+1")).remainder(new BigDecimal("30"));
    Assert.assertEquals("0", rc_BigDecimal.toString());
  }
  ...
  public void testItem_0989()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\uFFFF', '\1', '\234', '\234', '\1', '\uFFFF', '\uFFFF', '\1', '\0', '\1', '\234', '\uFFFF', '8', '\0', '8', '\234', '\1', '\234', '8', '8', '\234', '\uFFFF', '\0', '\234', '\0', '\1', '\uFFFF', '\234', '\0', '\234', '\uFFFF', '\234', '\uFFFF', '\uFFFF', '\0', '\uFFFF', '\1', '\uFFFF', '\234', '\0', '\0', '\1', '\uFFFF', '8', '\uFFFF', '\0', '8', '\0', '\0', '8', '8', '\0', '\1', '\1', '\234', '\0', '\0', '\0', '\0', '8', '8', '\234', '\uFFFF', '\uFFFF', '\234', '\uFFFF', '\234', '8', '\0', '\234', '\0', '\1', '\0', '\1', '\0', '\234', '\234', '8', '8', '\uFFFF', '8', '\uFFFF', '\234', '\1', '\uFFFF', '\uFFFF', '\1', '\uFFFF', '\0', '8', '\uFFFF', '\uFFFF', '\234', '\1', '\234', '\1', '\1', '\1', '\234', '\1'}, 0, 0, new MathContext("precision=1 roundingMode=HALF_UP"));
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0993()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = new BigDecimal(new char[]{'\uFFFF', '\1', '\0', '8', '\0', '\uFFFF', '\234', '\0', '\1', '8', '\0', '\1', '\234', '\234', '\0', '\uFFFF', '\234', '\234', '\234', '\0', '\1', '\0', '8', '\uFFFF', '\uFFFF', '8', '\0', '\234', '\1', '\234', '8', '\uFFFF', '\1', '\1', '\234', '\234', '\234', '\uFFFF', '\0', '\0', '\0', '\0', '\234', '\uFFFF', '\1', '\0', '\uFFFF', '\0', '8', '\uFFFF', '8', '\uFFFF', '\0', '8', '\0', '\1', '\uFFFF', '\234', '8', '\234', '\1', '8', '\234', '8', '\uFFFF', '\0', '8', '\uFFFF', '\0', '\0', '\0', '8', '8', '\1', '8', '8', '8', '\1', '8', '\uFFFF', '\1', '\1', '\234', '\uFFFF', '\0', '\0', '\234', '\234', '8', '\0', '\234', '8', '\uFFFF', '\uFFFF', '8', '\1', '\uFFFF', '\1', '\uFFFF', '\0'});
    }
    catch (java.lang.NumberFormatException e) {
      caught = true;
    }
  ...
  public void testItem_0996()
  {
    ...
    caught = false;
    try {
      rc_BigDecimal = (new BigDecimal("64")).pow(-1);
    }
    catch (java.lang.ArithmeticException e) {
      caught = true;
    }
  ...
  {
    rc_BigDecimal = (new BigDecimal("30")).divideToIntegralValue(new BigDecimal("3E+1"));
    Assert.assertEquals("1.0", rc_BigDecimal.toString());
  }
}
